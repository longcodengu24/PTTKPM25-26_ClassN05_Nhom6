<?php $__env->startSection('title', 'Chỉnh Sửa Sheet Nhạc'); ?>
...
<div id="products-edit" class="admin-content active px-6 pb-6">
    <div class="admin-card rounded-xl p-6">
        ...
        <!-- Edit Form -->
        <form action="<?php echo e(route('saler.products.update', $product['id'])); ?>" method="POST" enctype="multipart/form-data" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white bg-opacity-5 rounded-lg p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-blue-200 mb-4">
                    <div>
                        <strong>File hiện tại:</strong> <?php echo e(!empty($product['file_path']) ? basename($product['file_path']) : 'Chưa có file'); ?>

                    </div>
                    <div>
                        <strong>Tạo lúc:</strong> <?php echo e($product['created_at'] ?? 'Chưa xác định'); ?>

                    </div>
                    <div>
                        <strong>Cập nhật lần cuối:</strong> <?php echo e($product['updated_at'] ?? 'Chưa xác định'); ?>

                    </div>
                    <div>
                        <strong>Lượt tải:</strong> <?php echo e($product['downloads_count'] ?? 0); ?>
                ...
                <div class="mb-4">
                    ...
                    <div class="mt-2">
                        <img src="<?php echo e(asset($product['image_path'])); ?>" alt="Current cover" class="h-24 w-auto object-cover rounded-lg border border-white border-opacity-30">
                    </div>
                </div>
                <?php endif; ?>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="author" 
                               id="author"
                               value="<?php echo e(old('author', $product['author'] ?? '')); ?>"
                               class="w-full px-4 py-3 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="transcribed_by" 
                               id="transcribed_by"
                               value="<?php echo e(old('transcribed_by', $product['transcribed_by'] ?? '')); ?>"
                               class="w-full px-4 py-3 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <div class="relative" x-data="{ 
                            open: false, 
                            selected: getCountryWithFlag('<?php echo e(old('country_region', $product['country_region'] ?? 'Việt Nam')); ?>'), 
                    ...
                    <div>
                        ...
                        <input type="number" 
                               ...
                               min="0" 
                               step="1000"
                               value="<?php echo e(old('price', $product['price'] ?? 0)); ?>"
                               class="w-full px-4 py-3 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                               placeholder="30000">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" 
                               name="youtube_url" 
                               id="youtube_url"
                               value="<?php echo e(old('youtube_url', $product['youtube_demo_url'] ?? '')); ?>"
                               class="w-full px-4 py-3 bg-white bg-opacity-20 border border-white border-opacity-30 rounded-lg text-white placeholder-blue-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    ...
                    <div>
                        ...
                        <label class="flex items-center">
                            <input type="checkbox" 
                                   ...
                                   id="is_active"
                                   value="1"
                                   <?php echo e(old('is_active', $product['is_active'] ?? false) ? 'checked' : ''); ?>
            ...
            <div class="flex justify-center space-x-4">
                <a href="<?php echo e(route('saler.products.index')); ?>" class="bg-gray-500 hover:bg-gray-600 px-8 py-3 rounded-lg text-white inter font-semibold text-lg">
                    ← Hủy bỏ
                </a>
...
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/saler/products/edit.blade.php ENDPATH**/ ?>