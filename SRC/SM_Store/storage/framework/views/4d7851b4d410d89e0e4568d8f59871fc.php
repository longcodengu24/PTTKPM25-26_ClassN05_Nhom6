...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Seller Dashboard'); ?></title>
...
<body class="sky-gradient min-h-screen">
    ...
    <div class="flex h-screen">
        ...
        <div class="admin-sidebar w-64 p-6 flex flex-col">
            ...
            <nav class="flex-1">
                <ul class="space-y-2">
                    <li><a href="<?php echo e(route('saler.dashboard')); ?>" class="sidebar-link w-full text-left px-4 py-3 rounded-lg text-white inter flex items-center space-x-3">📊 Dashboard</a></li>
                    <li><a href="<?php echo e(route('saler.products.index')); ?>" class="sidebar-link w-full text-left px-4 py-3 rounded-lg text-white inter flex items-center space-x-3">🎼 Sheet Nhạc</a></li>
                    <li><a href="<?php echo e(route('saler.orders')); ?>" class="sidebar-link w-full text-left px-4 py-3 rounded-lg text-white inter flex items-center space-x-3">🛒 Đơn Hàng</a></li>
                    <li><a href="<?php echo e(route('saler.profile')); ?>" class="sidebar-link w-full text-left px-4 py-3 rounded-lg text-white inter flex items-center space-x-3">👤 Hồ Sơ</a></li>
                </ul>
            ...
            <header class="admin-card m-6 rounded-xl p-6">
                <div class="flex justify-between items-center">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <a href="<?php echo e(route('logout')); ?>" class="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-lg text-white inter">
                            Đăng Xuất
                        </a>
...
</html><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/layouts/seller.blade.php ENDPATH**/ ?>