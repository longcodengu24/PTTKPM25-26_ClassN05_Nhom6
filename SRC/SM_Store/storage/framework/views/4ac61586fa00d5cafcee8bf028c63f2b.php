...
<div class="max-w-6xl mx-auto px-2 py-10">
	<div class="game-card rounded-2xl p-8">
		...
		<div class="flex flex-col md:flex-row gap-8">
			...
			<a href="<?php echo e(route('shop.index')); ?>" class="w-full py-3 rounded-lg border border-blue-200 text-blue-700 font-semibold text-lg text-center hover:bg-blue-50 transition">MUA THÊM SẢN PHẨM</a>
		</div>
	</div>
</div>
<script>
		...
		Promise.all(productPromises)
			.then(productResults => {
				...
				let cartItems = cartData.items.map((item, index) => {
				   ...
				   window.location.href = '<?php echo e(route("account.paycart")); ?>';
			})
			.catch(error => {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/account/cart.blade.php ENDPATH**/ ?>