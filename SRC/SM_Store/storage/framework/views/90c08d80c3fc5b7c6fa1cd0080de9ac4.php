...
<div class="max-w-lg mx-auto">
    <div class="flex flex-col items-center mb-8">
        ...
        <div class="text-yellow-200 text-lg mb-2">Số dư hiện tại: <span class="font-bold"><?php echo e(number_format($currentUser['coins'] ?? session('coins', 0))); ?></span> coins</div>
    </div>
    <div class="profile-card rounded-3xl p-8 shadow-2xl bg-white/30 border border-white/20 backdrop-blur-lg">
        <form id="depositForm" class="space-y-6" onsubmit="return false;">
            <?php echo csrf_field(); ?>
            <input type="hidden" id="user_id" name="user_id" value="<?php echo e(session('firebase_uid')); ?>">
            <div>
...
<?php echo $__env->make('layouts.account', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/account/deposit.blade.php ENDPATH**/ ?>