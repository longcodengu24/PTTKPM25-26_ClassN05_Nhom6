<?php $__env->startSection('title', 'Quản lý Đơn Hàng - Saler Dashboard'); ?>
...
<div class="p-6">
        ...
        <div class="admin-card rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white orbitron"><?php echo e(number_format($stats['pending_orders'] ?? 0)); ?></p>
                </div>
        ...
        <div class="admin-card rounded-xl p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-white orbitron"><?php echo e(number_format($stats['completed_orders'] ?? 0)); ?></p>
                </div>
    ...
    <div class="admin-card rounded-xl p-6 mb-6">
        <form action="<?php echo e(route('saler.orders')); ?>" method="GET">
            <div class="flex gap-4">
                ...
                <?php if(!empty($searchQuery)): ?>
                    <a href="<?php echo e(route('saler.orders')); ?>" class="px-6 py-2 bg-gray-500 hover:bg-gray-600 rounded-lg text-white inter flex items-center space-x-2">
                        <span>✕</span>
                        <span>Xóa</span>
                    </a>
                <?php endif; ?>
    ...
    <div class="admin-card rounded-xl p-6">
        ...
        <?php else: ?>
                ...
                <table class="w-full">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b border-gray-700 hover:bg-white hover:bg-opacity-5">
                            <td class="py-4 px-4">
                                <span class="text-white font-medium inter">#<?php echo e(substr($order['id'], 0, 8)); ?></span>
                            </td>
                            <td class="py-4 px-4">
                                <div class="flex items-center space-x-3">
                                    <div class="w-10 h-10 bg-blue-500 rounded-full flex items-center justify-center">
                                        <span class="text-white text-sm font-medium">
                                            <?php echo e(strtoupper(substr($order['buyer_name'] ?? 'U', 0, 2))); ?>

                                        </span>
                                    </div>
                                    <div>
                                        <p class="text-white font-medium inter"><?php echo e($order['buyer_name'] ?? 'Unknown'); ?></p>
                                        <p class="text-gray-300 text-sm"><?php echo e($order['buyer_email'] ?? 'N/A'); ?></p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-4 px-4">
                                <div class="flex items-center space-x-3">
                                    <?php if(!empty($order['image_path'])): ?>
                                        <img src="<?php echo e($order['image_path']); ?>" alt="<?php echo e($order['product_name']); ?>" 
                                             class="w-10 h-10 rounded object-cover">
                                    <?php endif; ?>
                                    <div>
                                        <p class="text-white"><?php echo e($order['product_name']); ?></p>
                                        <p class="text-gray-300 text-sm">1 sản phẩm</p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-4 px-4 text-white font-medium"><?php echo e(number_format($order['price'])); ?> VND</td>
                            <td class="py-4 px-4">
                                <?php
                                    $statusColors = [
                                ...
                                ?>
                                <span class="px-3 py-1 <?php echo e($statusColors[$status] ?? 'bg-gray-500 bg-opacity-20 text-gray-300'); ?> rounded-full text-sm">
                                    <?php echo e($statusLabels[$status] ?? $status); ?>

                                </span>
                            </td>
                            <td class="py-4 px-4 text-gray-300">
                                <?php echo e(date('d/m/Y', strtotime($order['purchased_at'] ?? now()))); ?>
            ...
            <div class="flex items-center justify-between mt-6">
                <span class="text-gray-300 text-sm">Hiển thị <?php echo e($orders->count()); ?> đơn hàng</span>
            </div>
        <?php endif; ?>
    </div>
</div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.seller', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/saler/orders/index.blade.php ENDPATH**/ ?>