...
<div class="max-w-lg mx-auto">
    <div class="flex flex-col items-center mb-8">
        ...
        <div class="text-yellow-200 text-lg mb-2">
            Số dư hiện tại: <span class="font-bold" id="currentBalance"><?php echo e(number_format($userData['coins'] ?? 0)); ?></span> coins
        </div>
    </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var currentBalance = <?php echo e($userData['coins'] ?? 0); ?>;
    ...
    form.onsubmit = function(e) {
        ...
        // Call API
        fetch('<?php echo e(route("account.withdraw.process")); ?>', {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.account', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/account/withdraw.blade.php ENDPATH**/ ?>