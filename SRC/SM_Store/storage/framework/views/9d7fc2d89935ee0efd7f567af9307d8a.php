...
document.addEventListener('DOMContentLoaded', function() {
	...
	window.processCheckout = function() {
		...
		// Call checkout API
		fetch('<?php echo e(route("shop.checkout")); ?>', {
			method: 'POST',
			headers: {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\app\laragon\www\cayvlon\PTTKPM25-26_ClassN05_Nhom6\SRC\SM_Store\resources\views/page/shop/cart.blade.php ENDPATH**/ ?>