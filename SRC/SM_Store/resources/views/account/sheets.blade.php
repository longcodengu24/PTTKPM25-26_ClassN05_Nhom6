...
<div class="profile-card rounded-2xl p-6">
    <div class="flex justify-between items-center mb-6">
        <h3 class="orbitron text-xl font-bold text-white">
            Sheet Nhạc Của Tôi ({{ 2 + (isset($totalUserProducts) ? $totalUserProducts : 0) }})
            @if(config('app.debug'))
            ...
            <tbody>
                ...
                <tr class="bg-white/10 hover:bg-white/20 transition rounded-xl">
                    ...
                    <td class="py-4 px-4 flex gap-2">
                        <button onclick="alert('Đây là dữ liệu mẫu')" class="px-4 py-1 rounded bg-blue-500 hover:bg-blue-600 text-white font-semibold shadow">Tải</button>
                    </td>
                </tr>
                <!-- Sheet đã mua -->
