...
<div class="max-w-lg mx-auto">
    <div class="flex flex-col items-center mb-8">
        ...
        <div class="text-yellow-200 text-lg mb-2">
            Số dư hiện tại: 
            <span class="font-bold">{{ number_format($currentUser['coins'] ?? session('coins', 0)) }}</span> coins
        </div>
    </div>
    ...
    <div class="profile-card rounded-3xl p-8 shadow-2xl bg-white/30 border border-white/20 backdrop-blur-lg">
        <form id="depositForm" class="space-y-6" onsubmit="return false;">
            ...
            <div class="text-xs text-gray-200 mt-2 text-center">
                * Thanh toán an toàn với SePay - Nạp ngay, nhận coins liền!
            </div>
        </form>
    </div>
</div>
        ...
        <div class="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl">
            <div class="text-center">
                ...
                <div class="mt-6 space-y-2">
                    <button id="checkPaymentBtn" class="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded-lg transition">
                        🔄 Kiểm tra thanh toán
                    </button>
                    <button id="closeModalBtn" class="w-full bg-gray-500 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-lg transition">
                        Đóng
                    </button>
                </div>
            </div>
